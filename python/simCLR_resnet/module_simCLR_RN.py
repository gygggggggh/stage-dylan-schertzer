...
class SimCLRModuleRNAll(pl.LightningModule):
    def __init__(self, input_channels=12, hidden_dim=512, output_dim=128, learning_rate=0.1):
        super().__init__()
        ...
        self.projection_head = SimCLRProjectionHead(embedding_dim, embedding_dim, output_dim)
