...
greatly benefits from having larger batch sizes.
In this example, we use a batch
...
We use the
`clothing dataset from Alex Grigorev
<https://github.com/alexeygrigorev/clothing-dataset>`_
for this tutorial.
...
#
# The default configuration with a batch size of 256
# and input resolution of 128
...
path_to_data = "/home/sacha/Desktop/stage-dylan-schertzer/stage_dylan/simCLR/datasets/clothing-dataset/images"
...
# %%
# Let's do the plot of the images.
# The leftmost image is the query image whereas
...
# note that we need to create exactly the same backbone
# in order to load the weights
